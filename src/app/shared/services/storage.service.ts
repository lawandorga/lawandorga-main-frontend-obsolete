...
export class StorageService {
  ...
  public static saveFile(bytes, filename: string) {
     ...
     */
    FileSaver.saveAs(StorageService.b64toBlob(bytes, getType(filename), 512), filename);
  }
  ...
  uploadEncryptedRecordDocuments(files: File[], record_id, callbackFinishedFn?: Function) {
    ...
    this.http.post(GetSpecialRecordUploadDocumentsApiUrl(record_id), formData, privateKeyPlaceholder).subscribe((res) => {
