...
import { GetFolderFrontUrlAbsolute, GetGroupFrontUrl } from '../../../statics/frontend_links.statics';
...
export class TableEntryInformationFolderPermissionComponent implements OnInit {
  ...
  onFolderPermissionGoToFolderClick(folderPermission: FolderPermission) {
    this.router.navigateByUrl(GetFolderFrontUrlAbsolute(folderPermission.folderPath)).catch((error) => {});
  }
